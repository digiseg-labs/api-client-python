...
class AccountsApi:
    ...
    def add_user_to_account(
        ...
        account_user_addition: AccountUserAddition,
        ...
        :type account_id: str
        :param account_user_addition: (required)
        :type account_user_addition: AccountUserAddition
        ...
        _param = self._add_user_to_account_serialize(
            account_id=account_id,
            account_user_addition=account_user_addition,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "AddUserToAccount201Response",
            '400': None,
            '403': None,
            '404': None,
        }
    ...
    @validate_call
    def add_user_to_account_with_http_info(
        self,
        account_id: StrictStr,
        account_user_addition: AccountUserAddition,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddUserToAccount201Response]:
        """Add user to account
    ...
    @validate_call
    def add_user_to_account_without_preload_content(
        self,
        account_id: StrictStr,
        account_user_addition: AccountUserAddition,
        _request_timeout: Union[
    ...
    def _add_user_to_account_serialize(
        self,
        account_id,
        account_user_addition,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if account_user_addition is not None:
            _body_params = account_user_addition
    ...
    def create_account(
        ...
        :param account_creation: (required)
    ...
    def create_account_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateAccount201Response]:
        """Create account
    ...
    def get_account_by_id(
        self,
        account_id: StrictStr,
        include: Annotated[Optional[List[AccountIncludeParam]], Field(description="Optional parameter used to define aux properties to load in the response")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type include: List[AccountIncludeParam]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    @validate_call
    def get_user_account_membership(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetUserAccountMembership200Response:
        ...
        _param = self._get_user_account_membership_serialize(
            account_id=account_id,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetUserAccountMembership200Response",
            '404': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_user_account_membership_with_http_info(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetUserAccountMembership200Response]:
        """Get a user's membership with an account
    ...
    @validate_call
    def get_user_account_membership_without_preload_content(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_user_account_membership_serialize(
        self,
        account_id,
        user_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/accounts/{account_id}/users/{user_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_users_by_account_id(
        ...
        filter_account_roles: Annotated[Optional[UserAccountRole], Field(description="Filter based on account roles, e.g. `owner`")] = None,
        ...
        :param filter_account_roles: Filter based on account roles, e.g. `owner`
        :type filter_account_roles: UserAccountRole
        ...
        _param = self._list_users_by_account_id_serialize(
            ...
            filter_account_roles=filter_account_roles,
    ...
    def _list_users_by_account_id_serialize(
        ...
        if filter_account_roles is not None:
            
            _query_params.append(('filter[account_roles]', filter_account_roles.value))
    ...
    def remove_user_from_account(
        ...
        _param = self._remove_user_from_account_serialize(
            account_id=account_id,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def remove_user_from_account_with_http_info(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def remove_user_from_account_without_preload_content(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    def _remove_user_from_account_serialize(
        self,
        account_id,
        user_id,
        _request_auth,
    ...
    @validate_call
    def update_user_account_membership(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        user_account_membership_update: UserAccountMembershipUpdate,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_id: (required)
        :type user_id: str
        :param user_account_membership_update: (required)
        :type user_account_membership_update: UserAccountMembershipUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_user_account_membership_serialize(
            account_id=account_id,
            user_id=user_id,
            user_account_membership_update=user_account_membership_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_user_account_membership_with_http_info(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        user_account_membership_update: UserAccountMembershipUpdate,
    ...
    @validate_call
    def update_user_account_membership_without_preload_content(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        user_account_membership_update: UserAccountMembershipUpdate,
    ...
    def _update_user_account_membership_serialize(
        self,
        account_id,
        user_id,
        user_account_membership_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if user_account_membership_update is not None:
            _body_params = user_account_membership_update
