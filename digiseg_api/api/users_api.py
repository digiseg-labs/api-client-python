...
class UsersApi:
    ...
    def add_user_to_account_0(
        ...
        _param = self._add_user_to_account_0_serialize(
    ...
    @validate_call
    def add_user_to_account_0_with_http_info(
        self,
        account_id: StrictStr,
        account_user_addition: AccountUserAddition,
        _request_timeout: Union[
    ...
    @validate_call
    def add_user_to_account_0_without_preload_content(
        self,
        account_id: StrictStr,
        account_user_addition: AccountUserAddition,
        _request_timeout: Union[
    ...
    def _add_user_to_account_0_serialize(
        self,
        account_id,
    ...
    def get_current_user(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AddUserToAccount201Response",
            '403': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_user_account_membership_0(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._get_user_account_membership_0_serialize(
            account_id=account_id,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_account_membership_0_with_http_info(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_account_membership_0_without_preload_content(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_user_account_membership_0_serialize(
        self,
        account_id,
        user_id,
        _request_auth,
    ...
    @validate_call
    def list_users_by_account_id_0(
        self,
        account_id: StrictStr,
        ...
        _param = self._list_users_by_account_id_0_serialize(
            account_id=account_id,
    ...
    @validate_call
    def list_users_by_account_id_0_with_http_info(
        self,
        account_id: StrictStr,
        filter_platform_roles: Annotated[Optional[UserPlatformRole], Field(description="Filter based on platform roles, e.g. super_admin")] = None,
        filter_account_roles: Annotated[Optional[UserAccountRole], Field(description="Filter based on account roles, e.g. `owner`")] = None,
    ...
    @validate_call
    def list_users_by_account_id_0_without_preload_content(
        self,
        account_id: StrictStr,
        filter_platform_roles: Annotated[Optional[UserPlatformRole], Field(description="Filter based on platform roles, e.g. super_admin")] = None,
        filter_account_roles: Annotated[Optional[UserAccountRole], Field(description="Filter based on account roles, e.g. `owner`")] = None,
    ...
    def _list_users_by_account_id_0_serialize(
        self,
        account_id,
    ...
    @validate_call
    def remove_user_from_account_0(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._remove_user_from_account_0_serialize(
            account_id=account_id,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def remove_user_from_account_0_with_http_info(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def remove_user_from_account_0_without_preload_content(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        _request_timeout: Union[
    ...
    def _remove_user_from_account_0_serialize(
        self,
        account_id,
        user_id,
        _request_auth,
    ...
    @validate_call
    def update_user_account_membership_0(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        ...
        _param = self._update_user_account_membership_0_serialize(
            account_id=account_id,
            user_id=user_id,
    ...
    @validate_call
    def update_user_account_membership_0_with_http_info(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        user_account_membership_update: UserAccountMembershipUpdate,
    ...
    @validate_call
    def update_user_account_membership_0_without_preload_content(
        self,
        account_id: StrictStr,
        user_id: StrictStr,
        user_account_membership_update: UserAccountMembershipUpdate,
    ...
    def _update_user_account_membership_0_serialize(
        self,
        account_id,
        user_id,
