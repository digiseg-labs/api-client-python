...
class SubscriptionsApi:
    ...
    @validate_call
    def get_account_subscription_by_id_0(
        self,
        ...
        _param = self._get_account_subscription_by_id_0_serialize(
    ...
    @validate_call
    def get_account_subscription_by_id_0_with_http_info(
        self,
        account_id: StrictStr,
        subscription_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_account_subscription_by_id_0_without_preload_content(
        self,
        account_id: StrictStr,
        subscription_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_account_subscription_by_id_0_serialize(
        self,
        account_id,
        subscription_id,
        _request_auth,
    ...
    @validate_call
    def get_account_subscriptions_0(
        self,
        account_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_account_subscriptions_0_serialize(
            account_id=account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_account_subscriptions_0_with_http_info(
        self,
        account_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_account_subscriptions_0_without_preload_content(
        self,
        account_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_account_subscriptions_0_serialize(
        self,
        account_id,
        _request_auth,
        _content_type,
    ...
    def list_subscription_offers(
        self,
        filter_account_id: Annotated[Optional[StrictStr], Field(description="Optional parameter used to filter on the account ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param filter_account_id: Optional parameter used to filter on the account ID
        ...
        _param = self._list_subscription_offers_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListSubscriptionOffers200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_subscription_offers_with_http_info(
        self,
        filter_account_id: Annotated[Optional[StrictStr], Field(description="Optional parameter used to filter on the account ID")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSubscriptionOffers200Response]:
        """List subscription offers
    ...
    @validate_call
    def list_subscription_offers_without_preload_content(
        self,
        filter_account_id: Annotated[Optional[StrictStr], Field(description="Optional parameter used to filter on the account ID")] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_subscription_offers_serialize(
        self,
        filter_account_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscription_offers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
