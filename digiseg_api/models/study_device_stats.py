...
class StudyDeviceStats(BaseModel):
    """
    StudyDeviceStats
    """ # noqa: E501
    device_types: List[StudyDeviceTypeCategoryStats]
    __properties: ClassVar[List[str]] = ["device_types"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyDeviceStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyDeviceStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "device_types": [StudyDeviceTypeCategoryStats.from_dict(_item) for _item in obj["device_types"]] if obj.get("device_types") is not None else None
        })
        return _obj
