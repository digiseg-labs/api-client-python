...
class UserAccountMembershipUpdate(BaseModel):
    """
    UserAccountMembershipUpdate
    """ # noqa: E501
    roles: List[UserAccountRole] = Field(description="The roles to apply to the user within the account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserAccountMembershipUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserAccountMembershipUpdate from a dict"""
        if obj is None:
            return None
