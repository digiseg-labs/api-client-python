...
class MeasurementEventLinkParameterInfo(BaseModel):
    """
    MeasurementEventLinkParameterInfo
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="A description of what the parameter is used for")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementEventLinkParameterInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementEventLinkParameterInfo from a dict"""
        if obj is None:
            return None
