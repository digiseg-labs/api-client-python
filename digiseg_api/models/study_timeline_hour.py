...
class StudyTimelineHour(BaseModel):
    """
    Represents a UTC hour of gathering timeline data for a study.
    """ # noqa: E501
    hour: Optional[Annotated[int, Field(le=23, strict=True, ge=0)]] = Field(default=None, description="The hour of the day (from 0-23) in UTC time")
    count: Optional[StrictInt] = Field(default=None, description="The total count of events recorded in the hour.")
    __properties: ClassVar[List[str]] = ["hour", "count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyTimelineHour from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyTimelineHour from a dict"""
        if obj is None:
            return None
