...
class PopulationSourceBusinessCategorySetSize(BaseModel):
    """
    ...
    ba2: StrictInt
    ba3: StrictInt
    __properties: ClassVar[List[str]] = ["ba1", "ba2", "ba3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourceBusinessCategorySetSize from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourceBusinessCategorySetSize from a dict"""
        if obj is None:
            return None
