...
class SubscriptionOfferBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account_id", "subscription_plan_id", "accepted_by", "accepted_at", "original_plan_id", "offered_price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionOfferBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionOfferBase from a dict"""
        if obj is None:
            return None
