...
class CampaignAux(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_links", "integration_platform", "banner_image_url", "client"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CampaignAux from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CampaignAux from a dict"""
        if obj is None:
            return None
