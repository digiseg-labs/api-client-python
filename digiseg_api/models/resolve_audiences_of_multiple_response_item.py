...
class ResolveAudiencesOfMultipleResponseItem(BaseModel):
    """
    ResolveAudiencesOfMultipleResponseItem
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The identifier (if provided) of the item as it was provided in the request.")
    audiences: Optional[List[Audience]] = None
    status: AudienceResponseStatus
    __properties: ClassVar[List[str]] = ["id", "audiences", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResolveAudiencesOfMultipleResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResolveAudiencesOfMultipleResponseItem from a dict"""
        if obj is None:
            return None
