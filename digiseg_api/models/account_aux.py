...
class AccountAux(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["owner_id", "billing_email", "billing_address", "billing_tax_ids", "billing_currency", "billing_name", "stripe_customer_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountAux from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountAux from a dict"""
        if obj is None:
            return None
