...
class RegistrationVerificationResponseLinks(BaseModel):
    """
    RegistrationVerificationResponseLinks
    """ # noqa: E501
    user: Optional[StrictStr] = Field(default=None, description="Link of the created user")
    account: Optional[StrictStr] = Field(default=None, description="Link of the created account")
    __properties: ClassVar[List[str]] = ["user", "account"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistrationVerificationResponseLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistrationVerificationResponseLinks from a dict"""
        if obj is None:
            return None
