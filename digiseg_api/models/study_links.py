...
class StudyLinks(BaseModel):
    ...
    StudyLinks
    """ # noqa: E501
    stats_countries: Optional[StrictStr] = Field(default=None, description="Link to the country statistics for the study")
    stats_audiences: Optional[StrictStr] = Field(default=None, description="Link to the audience statistics for the study")
    stats_timing: Optional[StrictStr] = Field(default=None, description="Link to the timing statistics for the study")
    stats_frequencies: Optional[StrictStr] = Field(default=None, description="Link to the frequency statistics for the study")
    __properties: ClassVar[List[str]] = ["stats_countries", "stats_audiences", "stats_timing", "stats_frequencies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyLinks from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stats_countries": obj.get("stats_countries"),
            "stats_audiences": obj.get("stats_audiences"),
            "stats_timing": obj.get("stats_timing"),
            "stats_frequencies": obj.get("stats_frequencies")
        })
        return _obj
