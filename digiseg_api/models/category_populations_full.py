...
class CategoryPopulationsFull(BaseModel):
    """
    CategoryPopulationsFull
    """ # noqa: E501
    populations: Optional[List[PopulationItem]] = None
    __properties: ClassVar[List[str]] = ["populations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CategoryPopulationsFull from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CategoryPopulationsFull from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "populations": [PopulationItem.from_dict(_item) for _item in obj["populations"]] if obj.get("populations") is not None else None
        })
        return _obj
