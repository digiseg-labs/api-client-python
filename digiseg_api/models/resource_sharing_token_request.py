...
class ResourceSharingTokenRequest(BaseModel):
    """
    ResourceSharingTokenRequest
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="An optional ID to encode into the token to enable future identification of it")
    resource_urls: Optional[List[StrictStr]] = None
    account_id: Optional[StrictStr] = Field(default=None, description="The ID of the account to create the resource sharing token for. The account ID will be encoded into the token and ensure that e.g. subscription limitations and account settings are carried over to the interactions provided with the token. ")
    expires_in: Optional[StrictInt] = Field(default=None, description="The duration of time (in seconds) the resource sharing token is granted for")
    __properties: ClassVar[List[str]] = ["id", "resource_urls", "account_id", "expires_in"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceSharingTokenRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceSharingTokenRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "resource_urls": obj.get("resource_urls"),
