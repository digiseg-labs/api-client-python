...
class PopulationItem(BaseModel):
    ...
    PopulationItem
    """ # noqa: E501
    key: StrictStr = Field(description="A unique key for the population")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationItem from a dict"""
        if obj is None:
            return None
