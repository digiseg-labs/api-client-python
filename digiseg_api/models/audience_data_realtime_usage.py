...
class AudienceDataRealtimeUsage(BaseModel):
    """
    AudienceDataRealtimeUsage
    """ # noqa: E501
    when: datetime = Field(description="The point in time of recording the usage data")
    usage: AudienceDataUsage
    __properties: ClassVar[List[str]] = ["when", "usage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceDataRealtimeUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceDataRealtimeUsage from a dict"""
        if obj is None:
            return None
