...
class StudyCountryStats(BaseModel):
    """
    StudyCountryStats
    """ # noqa: E501
    predominant_country: Optional[StrictStr] = Field(default=None, description="The country code of the predominant country of the study")
    countries: Optional[List[CountryStats]] = Field(default=None, description="A listing of each countries observed and the relevant measurements for each")
    resolved: Optional[MeasurementsContainer] = None
    not_resolved: Optional[MeasurementsContainer] = None
    __properties: ClassVar[List[str]] = ["predominant_country", "countries", "resolved", "not_resolved"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyCountryStats from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.not_resolved:
            _dict['not_resolved'] = self.not_resolved.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyCountryStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "predominant_country": obj.get("predominant_country"),
            "countries": [CountryStats.from_dict(_item) for _item in obj["countries"]] if obj.get("countries") is not None else None,
            "resolved": MeasurementsContainer.from_dict(obj["resolved"]) if obj.get("resolved") is not None else None,
            "not_resolved": MeasurementsContainer.from_dict(obj["not_resolved"]) if obj.get("not_resolved") is not None else None
        })
        return _obj
