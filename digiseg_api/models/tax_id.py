...
class TaxId(BaseModel):
    ...
    """ # noqa: E501
    value: StrictStr = Field(description="The Tax ID number / code")
    type: StrictStr = Field(description="The type of Tax ID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaxId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaxId from a dict"""
        if obj is None:
            return None
