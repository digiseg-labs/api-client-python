...
class StudyPermissions(BaseModel):
    ...
    """ # noqa: E501
    get: StrictBool = Field(description="Can the current user GET (read) study information?")
    put: StrictBool = Field(description="Can the current user PUT (update) study information?")
    delete: StrictBool = Field(description="Can the current user DELETE the study?")
    __properties: ClassVar[List[str]] = ["get", "put", "delete"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyPermissions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyPermissions from a dict"""
        if obj is None:
            return None
