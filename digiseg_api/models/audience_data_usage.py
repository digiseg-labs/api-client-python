...
class AudienceDataUsage(BaseModel):
    """
    AudienceDataUsage
    """ # noqa: E501
    records_fulfilled: Optional[StrictInt] = Field(default=None, description="Number of records fulfilled")
    records_processed: Optional[StrictInt] = Field(default=None, description="Number of records processed")
    __properties: ClassVar[List[str]] = ["records_fulfilled", "records_processed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceDataUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceDataUsage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "records_fulfilled": obj.get("records_fulfilled"),
