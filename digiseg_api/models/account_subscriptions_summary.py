...
class AccountSubscriptionsSummary(BaseModel):
    """
    ...
    subscriptions: List[AccountSubscriptionItem]
    feature_set: PlanFeatureSet
    __properties: ClassVar[List[str]] = ["account_id", "subscriptions", "feature_set"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountSubscriptionsSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountSubscriptionsSummary from a dict"""
        if obj is None:
            return None
