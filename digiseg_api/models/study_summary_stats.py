...
class StudySummaryStats(BaseModel):
    """
    StudySummaryStats
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["private", "business", "not_resolved"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudySummaryStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudySummaryStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "private": MeasurementsContainer.from_dict(obj["private"]) if obj.get("private") is not None else None,
            "business": MeasurementsContainer.from_dict(obj["business"]) if obj.get("business") is not None else None,
