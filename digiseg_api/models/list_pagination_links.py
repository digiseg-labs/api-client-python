...
class ListPaginationLinks(BaseModel):
    """
    ListPaginationLinks
    """ # noqa: E501
    first: Optional[StrictStr] = Field(default=None, description="Link to the first page of the list")
    next: Optional[StrictStr] = Field(default=None, description="Link to the next page of the list")
    __properties: ClassVar[List[str]] = ["first", "next"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPaginationLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPaginationLinks from a dict"""
        if obj is None:
            return None
