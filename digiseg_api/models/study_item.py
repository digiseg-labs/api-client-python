...
class StudyItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "account_id", "start_date", "end_date", "life_cycle_stage", "ingestion_status", "summary_stats", "client"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyItem from a dict"""
        if obj is None:
            return None
