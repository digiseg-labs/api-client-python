...
class MeasurementClientItem(BaseModel):
    """
    MeasurementClientItem
    """ # noqa: E501
    id: StrictStr = Field(description="Unique ID for the object")
    name: Optional[StrictStr] = Field(default=None, description="The name of the measurement client")
    account_id: Optional[StrictStr] = Field(default=None, description="The ID of the account that owns this client")
    logo_url: Optional[StrictStr] = Field(default=None, description="The URL of an image representing the measurement client")
    __properties: ClassVar[List[str]] = ["id", "name", "account_id", "logo_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementClientItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementClientItem from a dict"""
        if obj is None:
            return None
