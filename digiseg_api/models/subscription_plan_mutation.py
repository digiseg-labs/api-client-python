...
class SubscriptionPlanMutation(BaseModel):
    """
    ...
    is_public: Optional[StrictBool] = Field(default=None, description="Is the plan/price a public price or custom?")
    __properties: ClassVar[List[str]] = ["feature_set", "display_name", "code", "is_public"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionPlanMutation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionPlanMutation from a dict"""
        if obj is None:
            return None
