...
class Audience(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="The audience category")
    code: Optional[StrictStr] = Field(default=None, description="The unique audience code")
    name: Optional[StrictStr] = Field(default=None, description="The name of the audience, typically of the form \"{category name} > {audience name}\"")
