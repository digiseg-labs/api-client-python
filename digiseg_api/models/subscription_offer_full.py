...
class SubscriptionOfferFull(BaseModel):
    """
    SubscriptionOfferFull
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique ID for the object")
    account_id: StrictStr = Field(description="The ID of the account that has the offer")
    subscription_plan_id: Optional[StrictStr] = Field(default=None, description="The ID of the subscription plan that is offered (may have changed from the original, or may not exist yet)")
    accepted_by: Optional[StrictStr] = Field(default=None, description="The ID of the user who accepted the offer")
    accepted_at: Optional[datetime] = Field(default=None, description="Date and time of the acceptance")
    original_plan_id: Optional[StrictStr] = Field(default=None, description="The ID of the subscription plan that this offer was originally based on")
    offered_price: SubscriptionPrice
    plan: Optional[SubscriptionPlanFull] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "account_id", "subscription_plan_id", "accepted_by", "accepted_at", "original_plan_id", "offered_price", "plan", "created_at", "created_by", "updated_at", "updated_by"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionOfferFull from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of offered_price
        if self.offered_price:
            _dict['offered_price'] = self.offered_price.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionOfferFull from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "original_plan_id": obj.get("original_plan_id"),
            "offered_price": SubscriptionPrice.from_dict(obj["offered_price"]) if obj.get("offered_price") is not None else None,
