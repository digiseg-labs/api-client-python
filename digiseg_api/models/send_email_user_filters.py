...
class SendEmailUserFilters(BaseModel):
    """
    ...
    filter_account_id: Optional[StrictStr] = None
    filter_platform_role: Optional[UserPlatformRole] = None
    filter_account_role: Optional[UserAccountRole] = None
    __properties: ClassVar[List[str]] = ["query_type", "user_id", "filter_account_id", "filter_platform_role", "filter_account_role"]

    @field_validator('query_type')
    def query_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['single_user', 'users_filter', 'everyone']):
            raise ValueError("must be one of enum values ('single_user', 'users_filter', 'everyone')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendEmailUserFilters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendEmailUserFilters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "filter_account_id": obj.get("filter_account_id"),
            "filter_platform_role": obj.get("filter_platform_role"),
            "filter_account_role": obj.get("filter_account_role")
        })
        return _obj
