...
class UserCreation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "name", "account_id", "roles", "avatar_url", "logged_in_at", "account_memberships", "is_super_admin", "platform_roles", "password", "notify_user"]
