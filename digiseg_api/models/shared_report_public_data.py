...
class SharedReportPublicData(BaseModel):
    ...
    """ # noqa: E501
    study_id: StrictStr
    access_token: Optional[StrictStr] = Field(default=None, description="Access token that can be used for API requests, if the user is not already authenticated")
    __properties: ClassVar[List[str]] = ["study_id", "access_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharedReportPublicData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharedReportPublicData from a dict"""
        if obj is None:
            return None
