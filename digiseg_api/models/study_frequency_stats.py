...
class StudyFrequencyStats(BaseModel):
    """
    StudyFrequencyStats
    """ # noqa: E501
    average_frequency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average frequency of events per user. ")
    ...
    count_above_cap: Optional[StrictInt] = Field(default=None, description="The number of users that have generated events at a frequency value greater than those represented in `frequencies`. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyFrequencyStats from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.frequencies:
            for _item_frequencies in self.frequencies:
                if _item_frequencies:
                    _items.append(_item_frequencies.to_dict())
            _dict['frequencies'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyFrequencyStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "frequencies": [FrequencyStats.from_dict(_item) for _item in obj["frequencies"]] if obj.get("frequencies") is not None else None,
