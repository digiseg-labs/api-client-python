...
class AudienceDataMonthlyUsage(BaseModel):
    """
    AudienceDataMonthlyUsage
    """ # noqa: E501
    year: StrictInt = Field(description="Year number")
    month: Annotated[int, Field(le=12, strict=True, ge=1)] = Field(description="Month number (1-12)")
    usage: AudienceDataUsage
    __properties: ClassVar[List[str]] = ["year", "month", "usage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceDataMonthlyUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceDataMonthlyUsage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "year": obj.get("year"),
            "month": obj.get("month"),
            "usage": AudienceDataUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
