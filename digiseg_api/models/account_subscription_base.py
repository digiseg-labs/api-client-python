...
class AccountSubscriptionBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "start_date", "end_date", "is_active", "cancelled_at", "actual_price", "payment_configuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountSubscriptionBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountSubscriptionBase from a dict"""
        if obj is None:
            return None
