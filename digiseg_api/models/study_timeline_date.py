...
class StudyTimelineDate(BaseModel):
    """
    Represents a UTC date of gathering timeline data for a study.
    """ # noqa: E501
    var_date: date = Field(alias="date")
    hours: List[StudyTimelineHour]
    __properties: ClassVar[List[str]] = ["date", "hours"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyTimelineDate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyTimelineDate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "hours": [StudyTimelineHour.from_dict(_item) for _item in obj["hours"]] if obj.get("hours") is not None else None
        })
        return _obj
