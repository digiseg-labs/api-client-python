...
class QueryCampaignTimingStats200Response(BaseModel):
    """
    QueryCampaignTimingStats200Response
    """ # noqa: E501
    data: Optional[CampaignTimingStats] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of QueryCampaignTimingStats200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of QueryCampaignTimingStats200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": CampaignTimingStats.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
