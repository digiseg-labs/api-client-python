...
class StripeAccountSubscriptionCheckoutSession(BaseModel):
    """
    StripeAccountSubscriptionCheckoutSession
    """ # noqa: E501
    session_id: Optional[StrictStr] = None
    redirect_url: Optional[StrictStr] = Field(default=None, description="The URL to take the user to, to set up payment")
    __properties: ClassVar[List[str]] = ["session_id", "redirect_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StripeAccountSubscriptionCheckoutSession from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StripeAccountSubscriptionCheckoutSession from a dict"""
        if obj is None:
            return None
