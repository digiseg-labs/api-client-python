...
class PrivateAudienceStatsAllOfAudienceCategories(BaseModel):
    """
    PrivateAudienceStatsAllOfAudienceCategories
    """ # noqa: E501
    home_type: Optional[AudienceCategoryStats] = None
    savings: Optional[AudienceCategoryStats] = None
    lifecycle: Optional[AudienceCategoryStats] = None
    cars: Optional[AudienceCategoryStats] = None
    children: Optional[AudienceCategoryStats] = None
    education: Optional[AudienceCategoryStats] = None
    neighbourhood_type: Optional[AudienceCategoryStats] = None
    income: Optional[AudienceCategoryStats] = None
    home_ownership: Optional[AudienceCategoryStats] = None
    building_age: Optional[AudienceCategoryStats] = None
    living_space: Optional[AudienceCategoryStats] = None
    tech_level: Optional[AudienceCategoryStats] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrivateAudienceStatsAllOfAudienceCategories from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrivateAudienceStatsAllOfAudienceCategories from a dict"""
        if obj is None:
            return None
