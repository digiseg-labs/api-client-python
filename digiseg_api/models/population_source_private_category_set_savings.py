...
class PopulationSourcePrivateCategorySetSavings(BaseModel):
    """
    ...
    b2: StrictInt
    b3: StrictInt
    __properties: ClassVar[List[str]] = ["b1", "b2", "b3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetSavings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetSavings from a dict"""
        if obj is None:
            return None
