...
class AccountSubscriptionFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "start_date", "end_date", "is_active", "cancelled_at", "actual_price", "payment_configuration", "plan", "account_id", "last_paid_at", "created_at", "created_by", "updated_at", "updated_by"]
