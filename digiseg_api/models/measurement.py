...
class Measurement(BaseModel):
    ...
    restricted: Optional[StrictBool] = Field(default=None, description="An indicator that will be `true` when the measurement is not delivered because the account is limited (typically due to subscription terms). ")
