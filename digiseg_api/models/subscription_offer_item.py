...
class SubscriptionOfferItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "account_id", "subscription_plan_id", "accepted_by", "accepted_at", "original_plan_id", "offered_price", "created_at", "created_by", "updated_at", "updated_by"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionOfferItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionOfferItem from a dict"""
        if obj is None:
            return None
