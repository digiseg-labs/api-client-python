...
class AuthTokenRequest(BaseModel):
    ...
    account_id: Optional[StrictStr] = Field(default=None, description="Optional account_id to authenticate for, if the user has multiple account memberships")
    ...
    __properties: ClassVar[List[str]] = ["username", "otp", "password", "account_id", "refresh_token", "scopes"]
