...
class ApiKeyLinks(BaseModel):
    """
    ApiKeyLinks
    """ # noqa: E501
    user: Optional[StrictStr] = Field(default=None, description="Link for getting to the api key's user")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiKeyLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiKeyLinks from a dict"""
        if obj is None:
            return None
