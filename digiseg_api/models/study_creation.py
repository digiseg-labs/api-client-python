...
class StudyCreation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "labels", "account_id", "start_date", "life_cycle_stage", "ingestion_status", "summary_stats", "client", "event_links", "banner_image_url", "integration_platform", "event_set", "client_id"]
