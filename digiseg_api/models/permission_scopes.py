...
class PermissionScopes(BaseModel):
    ...
    """ # noqa: E501
    origin_domains: Optional[List[StrictStr]] = Field(default=None, description="A list of origin domains that will be allowed access through CORS and Referrer checks with the token or API key. A missing value, empty array or the value `*` grants access from any domain.")
    service_grants: Optional[List[StrictStr]] = Field(default=None, description="A list of service grants to allow access to use. A missing value, empty array or the value `*` grants access to all of the services that are available to non-admin and non-owner users of the account.")
    country_data: Optional[List[StrictStr]] = Field(default=None, description="A list of country-specific data sources to allow access to. A missing value, empty array or the value `*` grants access to any data source.")
    __properties: ClassVar[List[str]] = ["origin_domains", "service_grants", "country_data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PermissionScopes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PermissionScopes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "service_grants": obj.get("service_grants"),
            "country_data": obj.get("country_data")
        })
        return _obj
