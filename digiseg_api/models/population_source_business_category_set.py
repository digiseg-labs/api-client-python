...
class PopulationSourceBusinessCategorySet(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourceBusinessCategorySet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourceBusinessCategorySet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "size": PopulationSourceBusinessCategorySetSize.from_dict(obj["size"]) if obj.get("size") is not None else None
        })
        return _obj
