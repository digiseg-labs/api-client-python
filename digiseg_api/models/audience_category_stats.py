...
class AudienceCategoryStats(BaseModel):
    """
    AudienceCategoryStats
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the audience category")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceCategoryStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceCategoryStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "audiences": [AudienceStats.from_dict(_item) for _item in obj["audiences"]] if obj.get("audiences") is not None else None
        })
        return _obj
