...
class UserAccountMembershipBase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["account_id", "account_name", "roles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserAccountMembershipBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserAccountMembershipBase from a dict"""
        if obj is None:
            return None
