...
class PopulationSourcePrivateCategorySetHomeType(BaseModel):
    """
    PopulationSourcePrivateCategorySetHomeType
    """ # noqa: E501
    a1: StrictInt
    a2: StrictInt
    __properties: ClassVar[List[str]] = ["a1", "a2"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetHomeType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetHomeType from a dict"""
        if obj is None:
            return None
