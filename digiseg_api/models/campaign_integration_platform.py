...
class CampaignIntegrationPlatform(BaseModel):
    """
    The integration/platform with which a campaign is being delivered 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="An ID for the integration platform, if the integration platform is a known platform to Digiseg. Will be null/omitted if the platform name was entered manually as a string. ")
    name: Optional[StrictStr] = Field(default=None, description="The name of the integration platform.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CampaignIntegrationPlatform from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CampaignIntegrationPlatform from a dict"""
        if obj is None:
            return None
