...
class AudienceDataDailyUsage(BaseModel):
    """
    AudienceDataDailyUsage
    """ # noqa: E501
    var_date: date = Field(description="Date in ISO 8601 format", alias="date")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceDataDailyUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceDataDailyUsage from a dict"""
        if obj is None:
            return None
