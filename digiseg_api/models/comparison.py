...
class Comparison(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the comparison source")
    code: StrictStr = Field(description="The code of the comparison source")
    fraction_of_total: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="The \"fraction of total\" value that is being compared with. ")
    index: Annotated[int, Field(strict=True, ge=0)] = Field(description="The comparison index where 100 means that the measurement is completely aligned with the compared metric. Values below 100 means that the measurement is below the compared metric, and values above 100 means that the measurement is above the compared metric. ")
    __properties: ClassVar[List[str]] = ["name", "code", "fraction_of_total", "index"]
