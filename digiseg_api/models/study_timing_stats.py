...
class StudyTimingStats(BaseModel):
    """
    StudyTimingStats
    """ # noqa: E501
    hour_of_day: Optional[HourOfDayStats] = None
    day_of_week: Optional[DayOfWeekStats] = None
    day_of_month: Optional[DayOfMonthStats] = None
    __properties: ClassVar[List[str]] = ["hour_of_day", "day_of_week", "day_of_month"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyTimingStats from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of hour_of_day
        if self.hour_of_day:
            _dict['hour_of_day'] = self.hour_of_day.to_dict()
        # override the default output from pydantic by calling `to_dict()` of day_of_week
        if self.day_of_week:
            _dict['day_of_week'] = self.day_of_week.to_dict()
        # override the default output from pydantic by calling `to_dict()` of day_of_month
        if self.day_of_month:
            _dict['day_of_month'] = self.day_of_month.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyTimingStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hour_of_day": HourOfDayStats.from_dict(obj["hour_of_day"]) if obj.get("hour_of_day") is not None else None,
            "day_of_week": DayOfWeekStats.from_dict(obj["day_of_week"]) if obj.get("day_of_week") is not None else None,
            "day_of_month": DayOfMonthStats.from_dict(obj["day_of_month"]) if obj.get("day_of_month") is not None else None
        })
        return _obj
