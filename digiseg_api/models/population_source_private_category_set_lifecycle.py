...
class PopulationSourcePrivateCategorySetLifecycle(BaseModel):
    """
    ...
    c4: StrictInt
    c5: StrictInt
    __properties: ClassVar[List[str]] = ["c1", "c2", "c3", "c4", "c5"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetLifecycle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetLifecycle from a dict"""
        if obj is None:
            return None
