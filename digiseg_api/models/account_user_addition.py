...
class AccountUserAddition(BaseModel):
    """
    AccountUserAddition
    """ # noqa: E501
    email: StrictStr = Field(description="The email of the user (used as username when authenticating with password)")
    name: Optional[StrictStr] = Field(default=None, description="Human readable name of the user")
    roles: Optional[List[UserAccountRole]] = Field(default=None, description="The roles that the user will have within the account")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountUserAddition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountUserAddition from a dict"""
        if obj is None:
            return None
