...
class StudyAudienceStats(BaseModel):
    """
    StudyAudienceStats
    """ # noqa: E501
    not_resolved: Optional[MeasurementsContainer] = None
    business: Optional[BusinessAudienceStats] = None
    private: Optional[PrivateAudienceStats] = None
    __properties: ClassVar[List[str]] = ["not_resolved", "business", "private"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyAudienceStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyAudienceStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "business": BusinessAudienceStats.from_dict(obj["business"]) if obj.get("business") is not None else None,
            "private": PrivateAudienceStats.from_dict(obj["private"]) if obj.get("private") is not None else None
        })
        return _obj
