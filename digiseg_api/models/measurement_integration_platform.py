...
class MeasurementIntegrationPlatform(BaseModel):
    """
    The integration/platform with which a study is being delivered 
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True, max_length=26)]] = Field(default=None, description="An ID for the integration platform, if the integration platform is a known platform. Note that integration platform ID uniqueness is a responsibility of the client since this is simply an optional reference point to keep. Can be null/omitted if the platform name is a one-off value with just a string. ")
    name: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="The name of the integration platform.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementIntegrationPlatform from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementIntegrationPlatform from a dict"""
        if obj is None:
            return None
