...
class StudyDeviceTypeCategoryStats(BaseModel):
    """
    StudyDeviceTypeCategoryStats
    """ # noqa: E501
    category: StudyDeviceTypeCategory
    count: StrictInt = Field(description="The total count of events recorded for the device category.")
    sub_types: Optional[List[StudyDeviceSubTypeStats]] = None
    __properties: ClassVar[List[str]] = ["category", "count", "sub_types"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyDeviceTypeCategoryStats from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.sub_types:
            ...
            _dict['sub_types'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyDeviceTypeCategoryStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "sub_types": [StudyDeviceSubTypeStats.from_dict(_item) for _item in obj["sub_types"]] if obj.get("sub_types") is not None else None
        })
        return _obj
