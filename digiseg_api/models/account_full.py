...
class AccountFull(BaseModel):
    ...
    billing_currency: Optional[SubscriptionPriceCurrency] = SubscriptionPriceCurrency.EUR
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "logo_url", "website_url", "billing_country", "company_type", "company_size", "has_clients", "slug", "owner_id", "billing_email", "billing_address", "billing_tax_ids", "billing_currency", "billing_name", "stripe_customer_id", "feature_set", "subscriptions", "created_at", "created_by", "updated_at", "updated_by"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.billing_tax_ids:
            for _item_billing_tax_ids in self.billing_tax_ids:
                if _item_billing_tax_ids:
                    _items.append(_item_billing_tax_ids.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billing_currency": obj.get("billing_currency") if obj.get("billing_currency") is not None else SubscriptionPriceCurrency.EUR,
