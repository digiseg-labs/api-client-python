...
class CreateMeasurementClient201Response(BaseModel):
    """
    CreateMeasurementClient201Response
    """ # noqa: E501
    data: Optional[MeasurementClientFull] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateMeasurementClient201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateMeasurementClient201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": MeasurementClientFull.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
