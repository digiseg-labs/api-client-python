...
class FrequencyStats(BaseModel):
    ...
    FrequencyStats
    """ # noqa: E501
    frequency: Optional[StrictInt] = Field(default=None, description="A frequency of study impressions to users. * The value 1 means that the study has been exposed just once. * The value 2 means that the study has been exposed twice. * And so on... ")
