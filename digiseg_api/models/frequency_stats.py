...
class FrequencyStats(BaseModel):
    ...
    FrequencyStats
    """ # noqa: E501
    frequency: Optional[StrictInt] = Field(default=None, description="A frequency of study events to users. * The value 1 means that the study has been exposed just once. * The value 2 means that the study has been exposed twice. * And so on... ")
    count: Optional[StrictInt] = Field(default=None, description="The number of users that have generated events at the corresponding frequency")
    __properties: ClassVar[List[str]] = ["frequency", "count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FrequencyStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FrequencyStats from a dict"""
        if obj is None:
            return None
