...
class PlanFeatureSet(BaseModel):
    ...
    """ # noqa: E501
    max_users: StrictInt
    max_clients: StrictInt
    max_active_studies: StrictInt
    max_events_per_study: StrictInt
    max_audience_lookups_per_month: StrictInt
    study_audience_set: LimitedOrFullFeature
    study_event_set: LimitedOrFullFeature
    has_audience_recommendations: StrictBool
    has_report_customization: StrictBool
    has_report_sharing_clients: StrictBool
    has_report_sharing_public: StrictBool
    __properties: ClassVar[List[str]] = ["max_users", "max_clients", "max_active_studies", "max_events_per_study", "max_audience_lookups_per_month", "study_audience_set", "study_event_set", "has_audience_recommendations", "has_report_customization", "has_report_sharing_clients", "has_report_sharing_public"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanFeatureSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanFeatureSet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "max_clients": obj.get("max_clients"),
            "max_active_studies": obj.get("max_active_studies"),
            "max_events_per_study": obj.get("max_events_per_study"),
            "max_audience_lookups_per_month": obj.get("max_audience_lookups_per_month"),
            "study_audience_set": obj.get("study_audience_set"),
            "study_event_set": obj.get("study_event_set"),
            "has_audience_recommendations": obj.get("has_audience_recommendations"),
            "has_report_customization": obj.get("has_report_customization"),
            "has_report_sharing_clients": obj.get("has_report_sharing_clients"),
            "has_report_sharing_public": obj.get("has_report_sharing_public")
        })
        return _obj
