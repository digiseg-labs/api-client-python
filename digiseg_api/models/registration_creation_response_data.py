...
class RegistrationCreationResponseData(BaseModel):
    """
    RegistrationCreationResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = None
    email_sent: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "email_sent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistrationCreationResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistrationCreationResponseData from a dict"""
        if obj is None:
            return None
