...
class SubscriptionOfferCreation(BaseModel):
    """
    SubscriptionOfferCreation
    """ # noqa: E501
    original_plan_id: StrictStr = Field(description="The ID of the subscription plan")
    account_id: StrictStr = Field(description="The ID of the account that has the offer")
    offered_price: SubscriptionPrice
    __properties: ClassVar[List[str]] = ["original_plan_id", "account_id", "offered_price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionOfferCreation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionOfferCreation from a dict"""
        if obj is None:
            return None
