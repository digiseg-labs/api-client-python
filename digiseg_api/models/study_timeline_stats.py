...
class StudyTimelineStats(BaseModel):
    """
    StudyTimelineStats
    """ # noqa: E501
    dates: List[StudyTimelineDate]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyTimelineStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyTimelineStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dates": [StudyTimelineDate.from_dict(_item) for _item in obj["dates"]] if obj.get("dates") is not None else None
        })
        return _obj
