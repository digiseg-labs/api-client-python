...
class AccountSubscriptionItem(BaseModel):
    ...
    plan: Optional[SubscriptionPlanItem] = None
    __properties: ClassVar[List[str]] = ["id", "start_date", "end_date", "is_active", "cancelled_at", "actual_price", "payment_configuration", "plan"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountSubscriptionItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountSubscriptionItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plan": SubscriptionPlanItem.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
