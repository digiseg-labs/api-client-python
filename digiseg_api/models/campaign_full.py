...
class CampaignFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "account_id", "start_date", "life_cycle_stage", "ingestion_status", "event_links", "integration_platform", "banner_image_url", "client", "created_at", "created_by", "updated_at", "updated_by"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CampaignFull from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CampaignFull from a dict"""
        if obj is None:
            return None
