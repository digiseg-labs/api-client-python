...
class CampaignFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "account_id", "start_date", "life_cycle_stage", "ingestion_status", "event_links", "created_at", "created_by", "updated_at", "updated_by"]
