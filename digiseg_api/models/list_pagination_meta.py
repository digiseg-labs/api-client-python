...
class ListPaginationMeta(BaseModel):
    ...
    ListPaginationMeta
    """ # noqa: E501
    page: Optional[ListPaginationMetaPage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPaginationMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPaginationMeta from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "page": ListPaginationMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
