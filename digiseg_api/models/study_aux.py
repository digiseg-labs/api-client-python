...
class StudyAux(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_links", "event_cap", "banner_image_url", "integration_platform", "is_example"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyAux from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyAux from a dict"""
        if obj is None:
            return None
