...
class UserFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "name", "account_id", "roles", "avatar_url", "account_memberships", "is_super_admin", "created_at", "created_by", "updated_at", "updated_by"]
