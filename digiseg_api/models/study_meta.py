...
class StudyMeta(BaseModel):
    ...
    StudyMeta
    """ # noqa: E501
    permissions: Optional[StudyPermissions] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyMeta from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "permissions": StudyPermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None
        })
        return _obj
