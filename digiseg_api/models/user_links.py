...
class UserLinks(BaseModel):
    ...
    UserLinks
    """ # noqa: E501
    account: Optional[StrictStr] = Field(default=None, description="Link for getting to the user's account")
    apikeys: Optional[StrictStr] = Field(default=None, description="Link for getting to the user's api keys")
    __properties: ClassVar[List[str]] = ["account", "apikeys"]
