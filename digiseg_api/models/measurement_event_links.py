...
class MeasurementEventLinks(BaseModel):
    """
    ...
    """ # noqa: E501
    impression: Optional[MeasurementEventLink] = None
    click: Optional[MeasurementEventLink] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementEventLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementEventLinks from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "impression": MeasurementEventLink.from_dict(obj["impression"]) if obj.get("impression") is not None else None,
            "click": MeasurementEventLink.from_dict(obj["click"]) if obj.get("click") is not None else None
        })
