...
class PopulationSourcePrivateCategorySetChildren(BaseModel):
    """
    ...
    e2: StrictInt
    e3: StrictInt
    __properties: ClassVar[List[str]] = ["e1", "e2", "e3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetChildren from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetChildren from a dict"""
        if obj is None:
            return None
