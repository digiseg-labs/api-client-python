...
class PostalAddress(BaseModel):
    ...
    PostalAddress
    """ # noqa: E501
    line1: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The first line of the postal address")
    line2: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The second line of the postal address")
    city: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="The city of the billing address")
    postal_code: Optional[Annotated[str, Field(strict=True, max_length=16)]] = Field(default=None, description="The postal code of the billing address")
    state: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="The state of the billing address")
    __properties: ClassVar[List[str]] = ["line1", "line2", "city", "postal_code", "state"]
