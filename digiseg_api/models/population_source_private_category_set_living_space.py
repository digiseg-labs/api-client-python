...
class PopulationSourcePrivateCategorySetLivingSpace(BaseModel):
    """
    ...
    l2: StrictInt
    l3: StrictInt
    __properties: ClassVar[List[str]] = ["l1", "l2", "l3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetLivingSpace from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetLivingSpace from a dict"""
        if obj is None:
            return None
