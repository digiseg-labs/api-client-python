...
class SubscriptionPlanItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "display_name", "code", "is_public", "product_type", "list_price", "stripe_product_id", "stripe_price_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionPlanItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionPlanItem from a dict"""
        if obj is None:
            return None
