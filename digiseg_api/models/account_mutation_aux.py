...
class AccountMutationAux(BaseModel):
    """
    AccountMutationAux
    """ # noqa: E501
    company_type: Optional[CompanyType] = None
    __properties: ClassVar[List[str]] = ["company_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountMutationAux from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountMutationAux from a dict"""
        if obj is None:
            return None
