...
class CreateAccount201Response(BaseModel):
    """
    CreateAccount201Response
    """ # noqa: E501
    data: Optional[AccountFull] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAccount201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAccount201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": AccountFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": AccountLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
