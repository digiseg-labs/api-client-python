...
class MeasurementEventLink(BaseModel):
    """
    MeasurementEventLink
    """ # noqa: E501
    link: Optional[StrictStr] = Field(default=None, description="The base URI of the link to an event")
    parameters: Optional[Dict[str, MeasurementEventLinkParameterInfo]] = Field(default=None, description="Describes any parameters that can be added to the event link")
    __properties: ClassVar[List[str]] = ["link", "parameters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementEventLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementEventLink from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "parameters": dict(
                (_k, MeasurementEventLinkParameterInfo.from_dict(_v))
