...
class StudyMutationData(BaseModel):
    """
    StudyMutationData
    """ # noqa: E501
    event_set: Optional[MeasurementEventSet] = None
    client_id: Optional[StrictStr] = Field(default=None, description="The ID of the measurement client that this study is for")
    __properties: ClassVar[List[str]] = ["event_set", "client_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyMutationData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyMutationData from a dict"""
        if obj is None:
            return None
