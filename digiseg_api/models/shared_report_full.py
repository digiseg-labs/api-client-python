...
class SharedReportFull(BaseModel):
    """
    SharedReportFull
    """ # noqa: E501
    id: StrictStr = Field(description="Unique ID for the object")
    asset_url: Optional[StrictStr] = Field(default=None, description="URL of the publicly available asset")
    report_type: SharedReportType
    expires_at: Optional[datetime] = Field(default=None, description="Optional date/time that the shared report will expire. Default is 28 days after the time of creation.")
    study_id: Optional[StrictStr] = Field(default=None, description="ID of the study to which the report belongs")
    account_id: Optional[StrictStr] = Field(default=None, description="ID of the account that owns the study")
    ...
    __properties: ClassVar[List[str]] = ["id", "asset_url", "report_type", "expires_at", "study_id", "account_id", "created_at", "created_by", "updated_at", "updated_by"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharedReportFull from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharedReportFull from a dict"""
        if obj is None:
            return None
