...
class UserCreationNotification(BaseModel):
    """
    UserCreationNotification
    """ # noqa: E501
    notify_user: Optional[StrictBool] = Field(default=True, description="Whether or not to notify the user that they have been registered")
    __properties: ClassVar[List[str]] = ["notify_user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCreationNotification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCreationNotification from a dict"""
        if obj is None:
            return None
