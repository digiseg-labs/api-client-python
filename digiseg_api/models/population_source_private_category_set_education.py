...
class PopulationSourcePrivateCategorySetEducation(BaseModel):
    """
    ...
    f2: StrictInt
    f3: StrictInt
    __properties: ClassVar[List[str]] = ["f1", "f2", "f3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetEducation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetEducation from a dict"""
        if obj is None:
            return None
