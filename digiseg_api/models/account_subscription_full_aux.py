...
class AccountSubscriptionFullAux(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["account_id", "plan", "last_paid_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountSubscriptionFullAux from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountSubscriptionFullAux from a dict"""
        if obj is None:
            return None
