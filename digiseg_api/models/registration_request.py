...
class RegistrationRequest(BaseModel):
    ...
    RegistrationRequest
    """ # noqa: E501
    account_name: StrictStr = Field(description="The name of the account to create")
    owner_email: StrictStr = Field(description="The email of the account owner")
    owner_name: StrictStr = Field(description="The name of the account owner")
    __properties: ClassVar[List[str]] = ["account_name", "owner_email", "owner_name"]
