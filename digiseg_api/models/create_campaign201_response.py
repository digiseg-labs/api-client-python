...
class CreateCampaign201Response(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[CampaignFull] = None
    links: Optional[CampaignLinks] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CampaignFull.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": CampaignLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
