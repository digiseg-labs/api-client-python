...
class PopulationSourcePrivateCategorySetCars(BaseModel):
    """
    ...
    d2: StrictInt
    d3: StrictInt
    __properties: ClassVar[List[str]] = ["d1", "d2", "d3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetCars from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationSourcePrivateCategorySetCars from a dict"""
        if obj is None:
            return None
