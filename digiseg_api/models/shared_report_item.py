...
class SharedReportItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "asset_url", "report_type", "expires_at", "study_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharedReportItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharedReportItem from a dict"""
        if obj is None:
            return None
