...
class CreateStudy201Response(BaseModel):
    """
    CreateStudy201Response
    """ # noqa: E501
    data: Optional[StudyFull] = None
    links: Optional[StudyLinks] = None
    meta: Optional[StudyMeta] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateStudy201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateStudy201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": StudyFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": StudyLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "meta": StudyMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
