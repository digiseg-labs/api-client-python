...
class AudienceExampleInput(BaseModel):
    """
    AudienceExampleInput
    """ # noqa: E501
    ip_address: Optional[StrictStr] = Field(default=None, description="The IP address to resolve audiences for")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceExampleInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceExampleInput from a dict"""
        if obj is None:
            return None
