...
class PrivateAudienceStats(BaseModel):
    ...
    """ # noqa: E501
    measurements: List[Measurement] = Field(description="Measurements related to this object")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "audience_categories": PrivateAudienceStatsAudienceCategories.from_dict(obj["audience_categories"]) if obj.get("audience_categories") is not None else None
        })
        return _obj
