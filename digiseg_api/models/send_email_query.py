...
class SendEmailQuery(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendEmailQuery from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of include_users
        if self.include_users:
            _dict['include_users'] = self.include_users.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendEmailQuery from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "model_data": obj.get("model_data"),
            "include_users": SendEmailUserFilters.from_dict(obj["include_users"]) if obj.get("include_users") is not None else None
        })
        return _obj
