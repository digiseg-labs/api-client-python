...
class AccountOwnerCreation(BaseModel):
    """
    Information about the account owner of a newly created account. Can only be specified by super-admins.
    """ # noqa: E501
    name: StrictStr = Field(description="The account owner's name")
    email: StrictStr = Field(description="The account owner's email")
    password: Optional[StrictStr] = Field(default=None, description="The account owner's password")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountOwnerCreation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountOwnerCreation from a dict"""
        if obj is None:
            return None
