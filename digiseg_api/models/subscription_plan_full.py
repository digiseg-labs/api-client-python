...
class SubscriptionPlanFull(BaseModel):
    """
    SubscriptionPlanFull
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the plan/price that the account is subscribed to")
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "created_by", "updated_at", "updated_by", "display_name", "code", "is_public", "product_type", "list_price", "stripe_product_id", "stripe_price_id", "feature_set"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionPlanFull from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionPlanFull from a dict"""
        if obj is None:
            return None
