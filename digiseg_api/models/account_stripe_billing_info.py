...
class AccountStripeBillingInfo(BaseModel):
    """
    AccountStripeBillingInfo
    """ # noqa: E501
    billing_portal_url: Optional[StrictStr] = Field(default=None, description="The URL to take the user to, to configure their billing information")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["billing_portal_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountStripeBillingInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountStripeBillingInfo from a dict"""
        if obj is None:
            return None
