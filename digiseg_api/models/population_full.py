...
class PopulationFull(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopulationFull from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopulationFull from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "private": PopulationAudienceCategorySetPrivateSection.from_dict(obj["private"]) if obj.get("private") is not None else None,
            "business": PopulationAudienceCategorySetBusinessSection.from_dict(obj["business"]) if obj.get("business") is not None else None
        })
        return _obj
