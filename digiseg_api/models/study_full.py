...
class StudyFull(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "account_id", "start_date", "end_date", "life_cycle_stage", "ingestion_status", "summary_stats", "client", "event_links", "event_cap", "banner_image_url", "integration_platform", "is_example", "created_at", "created_by", "updated_at", "updated_by"]
