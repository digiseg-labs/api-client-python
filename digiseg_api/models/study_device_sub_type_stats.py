...
class StudyDeviceSubTypeStats(BaseModel):
    """
    StudyDeviceSubTypeStats
    """ # noqa: E501
    name: StrictStr
    count: StrictInt = Field(description="The total count of events recorded for the device.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyDeviceSubTypeStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyDeviceSubTypeStats from a dict"""
        if obj is None:
            return None
